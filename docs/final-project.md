...
8. короткая заметка по шаблону `docs/handoff-template.md`, включая маленький
   receipt по границам доверия.
...
| Границы безопасности: разделение чтения и записи, нет автономной обратной записи, live-путь не пишет в `vault/raw/` или `vault/wiki/`, в заметке есть короткий trust-boundary receipt | 10 |
